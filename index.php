...
<body class bg-light>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="home.php">Dream Place Hotel</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active fs-5" href="home.php">Home</a></li>
    ...
    <!-- Right Side: Room Cards with Horizontal Scrolling -->
<div class="col-lg-9">
    <div class="room-cards-container">
        <!-- Room Card 1 -->
        <div class="room-card">
            <img src="Images/photo/1.jpg" alt="Standard Room">
            <div class="room-card-body">
                <h5 class="room-card-title">Standard Room</h5>
                <p>Cozy and comfortable, perfect for solo travelers or couples.</p>
                <div class="mb-2">
                    <span class="badge bg-primary"><i class="bi bi-wind"></i> Air Conditioning</span>
                    <span class="badge bg-success"><i class="bi bi-fridge"></i> Mini Fridge</span>
                    <span class="badge bg-info"><i class="bi bi-wifi"></i> High-Speed Wi-Fi</span>
                </div>
                <p class="room-card-price">$2000/night</p>
        ...
        <!-- Room Card 2 -->
        <div class="room-card">
            <img src="Images/photo/5.jpg" alt="Superior Room">
            <div class="room-card-body">
                <h5 class="room-card-title">Superior Room</h5>
                <p>Spacious with modern amenities for a relaxed stay.</p>
                <div class="mb-2">
                    <span class="badge bg-primary"><i class="bi bi-wind"></i> Air Conditioning</span>
                    <span class="badge bg-success"><i class="bi bi-fridge"></i> Mini Fridge</span>
                    <span class="badge bg-warning"><i class="bi bi-tv"></i> Smart TV</span>
                </div>
                <p class="room-card-price">$2300/night</p>
                <button class="btn btn-primary shadow-none">Book Now</button>
            </div>
        </div>
        ...
        <!-- Room Card 3 -->
        <div class="room-card">
            <img src="Images/photo/6.jpg" alt="Super Deluxe Room">
            <div class="room-card-body">
                <h5 class="room-card-title">Super Deluxe Room</h5>
                <p>Luxurious room with exceptional amenities and services.</p>
                <div class="mb-2">
                    <span class="badge bg-primary"><i class="bi bi-wind"></i> Air Conditioning</span>
                    <span class="badge bg-danger"><i class="bi bi-cup"></i> Coffee Maker</span>
                    <span class="badge bg-warning"><i class="bi bi-tv"></i> Smart TV</span>
                    <span class="badge bg-info"><i class="bi bi-wifi"></i> High-Speed Wi-Fi</span>
                </div>
                <p class="room-card-price">$2800/night</p>
                <button class="btn btn-primary shadow-none">Book Now</button>
            </div>
        </div>
        ...
        <!-- Room Card 4 -->
        <div class="room-card">
            <img src="Images/photo/4.jpg" alt="Jr. Suite">
            <div class="room-card-body">
                <h5 class="room-card-title">Jr. Suite</h5>
                <p>Perfect for families with extra space and premium comfort.</p>
                <div class="mb-2">
                    <span class="badge bg-primary"><i class="bi bi-wind"></i> Air Conditioning</span>
                    <span class="badge bg-success"><i class="bi bi-fridge"></i> Refrigerator</span>
                    <span class="badge bg-warning"><i class="bi bi-tv"></i> Smart TV</span>
                    <span class="badge bg-info"><i class="bi bi-wifi"></i> High-Speed Wi-Fi</span>
                </div>
                <p class="room-card-price">$3800/night</p>
                <button class="btn btn-primary shadow-none">Book Now</button>
            </div>
        </div>
        ...
        <!-- Room Card 5 -->
        <div class="room-card">
            <img src="Images/photo/3.jpg" alt="Executive Suite">
            <div class="room-card-body">
                <h5 class="room-card-title">Executive Suite</h5>
                <p>Luxury suite with the best amenities for a perfect stay.</p>
                <div class="mb-2">
                    <span class="badge bg-primary"><i class="bi bi-wind"></i> Air Conditioning</span>
                    <span class="badge bg-success"><i class="bi bi-fridge"></i> Refrigerator</span>
                    <span class="badge bg-danger"><i class="bi bi-cup"></i> Coffee Maker</span>
                ...
                <p class="room-card-price">$4000/night</p>
                <button class="btn btn-primary shadow-none">Book Now</button>
            </div>
        </div>
    </div>
